...
import { ImportTraineesModal } from '../Trainees/ImportTraineesModal';
...
export const TraineeSelectionModal: React.FC<TraineeSelectionModalProps> = ({
  ...
  return (
    <>
        ...
        <div className="trainee-modal-backdrop" onClick={onClose}>
          ...
          >
            ...
            <div className="trainee-modal-header">
              ...
              <div className="trainee-header-right-actions">
                <button
                  type="button"
                  className="trainee-action-btn-accent"
                  onClick={() => setShowAddTraineeModal(true)}
                  title="Add a new individual trainee to directory"
                >
                  <UserPlus size={14} />
                ...
                <button
                  type="button"
                  className="trainee-action-btn-excel"
                  onClick={() => setShowImportModal(true)}
                  title="Import batch trainees from Excel / CSV file"
                >
            ...
            <div className="trainee-modal-toolbar">
              ...
              <div className="trainee-modal-actions-row">
                <div className="bulk-pill-buttons">
                  ...
                  <button
                    type="button"
                    className="bulk-action-pill add-btn"
                    onClick={() => setShowAddTraineeModal(true)}
                  >
                    <UserPlus size={13} />
                  ...
                  <button
                    type="button"
                    className="bulk-action-pill excel-btn"
                    onClick={() => setShowImportModal(true)}
                  >
      ...
      {/* SUB-MODALS FOR ADD NEW TRAINEE AND IMPORT EXCEL */}
      {showAddTraineeModal && (
        <AddTraineeModal onClose={() => setShowAddTraineeModal(false)} />
      )}

      {showImportModal && (
        <ImportTraineesModal isOpen={showImportModal} onClose={() => setShowImportModal(false)} />
      )}
    </>
  );
};
